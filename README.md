...
<html>
<head>
    <title>SLOT TIME TABLE - NAINA MOHAMED Z(23010605)</title>
    <style>
        table {
...
<body>
    ...
    <div class="center-text">
        <p><strong>SLOT TIME TABLE - NAINA MOHAMED Z(212223230131)</strong></p>
    </div>
    <table>
        <tr>
...
```
## OUTPUT
![Screenshot 2024-10-07 160425](https://github.com/user-attachments/assets/2e08026f-f75f-4ff4-95c6-1bdf8d944e26)
## RESULT
